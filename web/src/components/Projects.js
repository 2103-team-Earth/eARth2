  ...
  render() {
    return (
      <div className="page">
        ...
        <Button variant="light" href="/create">
          Create New Project
        </Button>
        ...
        {this.state.projects.length === 0 ? (
          <p>
            You do not currently have any projects. Click the button above to
            create a project.
          </p>
        ) : (
              ...
              return (
                <div className="user-project-div" key={project.id}>
                  ...
                  {project.colorSelected ? (
                    <h6>Color: {project.colorSelected}</h6>
                  ) : null}
                  {project.animation ? (
                    <h6>Animation: {project.animation}</h6>
                  ) : null}
                  {project.animate ? <h6>Animate: {project.animate}</h6> : null}
                  {project.text ? <h6>Text: {project.text}</h6> : null}
                  {project.textScaleX ? (
                    <h6>Text Scale X: {project.textScaleX}</h6>
                  ) : null}
                  {project.textScaleY ? (
                    <h6>Text Scale Y: {project.textScaleY}</h6>
                  ) : null}
                  {project.textScaleZ ? (
                    <h6>Text Scale Z: {project.textScaleZ}</h6>
                  ) : null}
                  {project.shapeScaleX ? (
                    <h6>Shape Scale X: {project.shapeScaleX}</h6>
                  ) : null}
                  {project.shapeScaleY ? (
                    <h6>Shape Scale Y: {project.shapeScaleY}</h6>
                  ) : null}
                  {project.shapeScaleZ ? (
                    <h6>Shape Scale Z: {project.shapeScaleZ}</h6>
                  ) : null}
                  {project.fontSize ? (
                    <h6>Font Size: {project.fontSize}</h6>
                  ) : null}
                  {project.textColor ? (
                    <h6>Text Color: {project.textColor}</h6>
                  ) : null}
