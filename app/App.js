...
function MyTabs() {
  return (
    <Tab.Navigator>
      <Tab.Screen name="AutoAR" component={_getARNavigator} />
      <Tab.Screen name="PlaneSelector" component={_getARPlaneSelector} />
      <Tab.Screen name="ARImageMarker" component={_getARImageMarker} />
    </Tab.Navigator>
  );
}
